...
Extra Horizon, commercializes it's platform as a managed service or solution or (SaaS) an thus the legal manufacturers have no direct control over the platforms software life cycle control. Regulations like FDA & MDR provide legal manufacturers with the ability to make use of third party software or Off-The-Shelf (OTS) under the consideration that the necessary documentation can be provided that guarantee safe operation.
...
In summary you will need to provide the following elements to include Extra Horizon as an OTS Software component in your product. Depending on your device and its risk to patients, users or others in the environment of use a Basic or Enhanced Documentation Level is determined for your submission.
...
## B. Risk Assessment of ITS Software
...
Our goal exists of easing the path for our customers as much as possible. Therefore Extra Horizon builds and operates it's software lifecycle processes according to **IEC62304** within the context of an ISO13485 certified quality management system. This ensures your can fully rely on the documentation and third party certificates Extra Horizon provides to you as a customer and require little to no verification and validation efforts from your end.
...
* A list of known annomalies associated with the version of the services your are using
...
{% hint style="success" %}
Extra Horizon's contracts include a clear Service Level Agreement (SLA) that contain crlear commitments from Extra Horizon to the properly operate, maintain, monitoring and support the platform that is provided to you.
{% endhint %}
